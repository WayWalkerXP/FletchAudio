...
ABS_DERIVED_METADATA_KEYS = ("author", "album", "series", "series_part", "asin", "chapters", "bitrate", "mode", "runtime")
SUPPORTED_ABS_METADATA_TAGS = frozenset(METADATA_KEYS + ABS_DERIVED_METADATA_KEYS)
...
CANONICAL_METADATA_VARIANT_KEYS = (
    "\xa9ART", "----:com.apple.iTunes:author", "aART", "----:com.apple.iTunes:albumartist",
    "----:com.apple.iTunes:album_artist", "----:com.apple.iTunes:narrator",
    "----:com.apple.iTunes:series", "----:com.apple.iTunes:series-part",
    "----:com.apple.iTunes:series_sequence", "----:com.apple.iTunes:sequence",
    "----:com.apple.iTunes:publisher", "----:com.apple.iTunes:language", ASIN_MP4_FREEFORM_KEY,
)
