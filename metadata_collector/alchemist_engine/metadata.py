...
def build_output_tags(descriptive_tags: dict[str, str], fallback_author: str, fallback_album: str, overrides: dict[str, str] | None = None, dramatic_audio: bool | None = None) -> dict[str, str]:
