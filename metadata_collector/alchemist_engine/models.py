...
class AppConfig:
    ...
    metadata_aliases_config: Path
    metadata_aliases: dict[str, tuple[str, ...]]
    processed_dir: Path
    abs_library_dir: Path | None
    abs_filename_template: str
    required_tags: tuple[str, ...]
    replace_spaces: bool
    space_replacement_char: str
    research_dir: Path | None
    collision_default_action: str
    abs_api_url: str
    abs_api_token: str
    trigger_abs_rescan: bool
    move_report_csv: Path
